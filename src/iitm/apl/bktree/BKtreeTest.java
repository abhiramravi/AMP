...
public class BKtreeTest
{
	public static void main(String[] args) throws IOException 
	{
		...
		HashMap<String,Integer> queryMap = bkTree.makeQuery("the", 3);
